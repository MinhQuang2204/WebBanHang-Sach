...
<link rel="stylesheet"
	href="<c:url value="./assets/js/login.js"></c:url>">
<link rel="stylesheet"
...
<body>
	...
	<div class="header">
		<div class="header-text">
			<a class="header-text-brand" href="home">NHQBook.vn</a>
		</div>
	</div>
	...
	<div class="content">
		<div class="dust-paarticle">
			...
			<svg width="100%" id="dust-paarticle" height="100%"
				viewBox="0 0 885 455" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
					...
					stroke="#F4CD39" stroke-width="2" stroke-miterlimit="10"
                ...
                <path
					...
					stroke="#FDB130" stroke-width="2" stroke-miterlimit="10"
					stroke-linecap="round" stroke-linejoin="round" />
                <path
					...
					stroke="#E03F8D" stroke-width="2" stroke-miterlimit="10"
					stroke-linecap="round" stroke-linejoin="round" />
                <path
					...
					stroke="#1DB7C2" stroke-width="2" stroke-miterlimit="10"
					stroke-linecap="round" stroke-linejoin="round" />
                <path
                ...
                <path
					...
					stroke="#9E3FB7" stroke-width="2" stroke-miterlimit="10"
					stroke-linecap="round" stroke-linejoin="round" />
                <path d="M768.2 366.7H775.5" stroke="#9E3FB7"
					stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
					stroke-linejoin="round" />
                <path d="M771.8 363.1V370.4" stroke="#9E3FB7"
					stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
					stroke-linejoin="round" />
                <g opacity="0.6">
                    <path opacity="0.6" d="M696.4 40.5H703.8"
					stroke="#9E3FB7" stroke-width="2" stroke-miterlimit="10"
					stroke-linecap="round" stroke-linejoin="round" />
                    <path opacity="0.6" d="M700.1 36.8V44.2"
					stroke="#9E3FB7" stroke-width="2" stroke-miterlimit="10"
					stroke-linecap="round" stroke-linejoin="round" />
                </g>
                <path d="M630.3 284.1H636" stroke="#E03F8D"
					stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
					stroke-linejoin="round" />
                <path d="M633.2 281.2V286.9" stroke="#E03F8D"
					stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
					stroke-linejoin="round" />
                <path d="M414.9 104.5H420.6" stroke="#E03F8D"
					stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
					stroke-linejoin="round" />
                <path d="M417.8 101.7V107.3" stroke="#E03F8D"
					stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
					stroke-linejoin="round" />
                <path d="M203.7 290.8H211.5" stroke="#E03F8D"
					stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
					stroke-linejoin="round" />
                <path d="M207.6 286.9V294.6" stroke="#E03F8D"
					stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"
					stroke-linejoin="round" />
                <path
		...
		<div class="container-fluid">
						...
						<div class="brand-col">
							<div class="headline">
								...
								<div class="brand-logo">
									<a class="brand-logo-text" href="home">NHQShop.vn</a>
								</div>
								<!-- ./brand-logo -->
								...
								<div class="row social-buttons">
									<div class="col-xs-4 col-sm-4 col-md-12">
										<a href="#" class="btn btn-block btn-facebook"> <i
											...
											class="hidden-xs hidden-sm social-button">Đăng nhập
												với Facebook</span>
										</a>
									</div>
									<div class="col-xs-4 col-sm-4 col-md-12">
		   ...
		   &client_id=53687840933-fd8nnbpaif4sjq16fj886kmkd0ml4fjb.apps.googleusercontent.com&approval_prompt=force"
											class="btn btn-block btn-google"> <i
					...
					<div class="col-sm-7 authfy-panel-right">
						...
						<div class="authfy-login">
							...
							<!-- panel-login start -->
							<div id="loginForm"
								class="authfy-panel panel-login text-center ${mask == 1 ? "active":""}">
								<div class="authfy-heading">
									<h3 class="auth-title">Đăng nhập</h3>
									<p>
										Bạn chưa có tài khoản? <a class="lnk-toggler"
											data-panel=".panel-signup" href="#"
											onclick="changeToSigninForm()">Đăng kí</a>
									</p>
									<%
										...
										<form name="loginForm" class="loginForm" action="loginAccount"
											...
											<div class="form-group">
												<div class="pwdMask">
													<input type="password" id="myInput"
														...
														class="fa fa-eye-slash pwd-toggle " onclick="myFunction()"></span>
												</div>
											</div>
											<!-- start remember-row -->
											<div class="row remember-row">
												<div class="col-xs-6 col-sm-6">
													<label class="checkbox text-left"> <input
														type="checkbox" value="remember-me"> <span
														class="label-text">Nhớ mật khẩu</span>
													</label>
												</div>
												<div class="col-xs-6 col-sm-6">
													<p class="forgotPwd">
														<a class="lnk-toggler" data-panel=".panel-forgot" href="#"
															onclick="changeToForgotPwdForm()">Quên mật khẩu?</a>
													</p>
												</div>
											</div>
											<!-- ./remember-row -->
											<div class="form-group">
												<!-- <a type="submit" target="_blank"
													class="btn btn-lg btn-primary btn-block">Đăng
													nhập</a> -->
												<input type="submit"
													class="btn btn-lg btn-primary btn-block" value="Đăng nhập">
							...
							<!-- panel-signup start -->
							<div id="signinForm"
								class="authfy-panel panel-signup text-center ${mask == 0 ? "active":""}">
								<div class="row">
									<div class="col-xs-12 col-sm-12">
										<div class="authfy-heading">
											<h3 class="auth-title">Đăng kí miễn phí</h3>
											<%
											if (session.getAttribute("ExitAccount") != null) {
												out.print("<p class='text-warning ml-1'>" + session.getAttribute("ExitAccount") + "</p>");
											}
											session.removeAttribute("ExitAccount");
											%>
										</div>
										<form action="layout-Signup?mask=0" name="signupForm"
											...
											<div class="form-group">
												<div class="pwdMask">
													<input name="password" type="password" id="Signup_Password"
														class="form-control password" name="password"
														placeholder="Mật khẩu" required> <span
											...
											<div class="form-group">
												<p class="term-policy text-muted small">
													Tôi động ý với <a href="#">chính sách</a> và <a href="#">điều
														khoản dịch vụ</a>.
												</p>
											</div>
											<div class="form-group">
										...
										<a class="lnk-toggler" data-panel=".panel-login" href="#"
											onclick="changeToLoginForm()">Bạn đã sẵn sàng để đăng
											nhập?</a>
									</div>
								</div>
							</div>
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12">
										...
										<form name="forgetForm" class="forgetForm"
											...
											<div class="form-group">
												<a class="lnk-toggler" data-panel=".panel-login" href="#"
													onclick="changeToLoginForm()">Đã có tài khoản?</a>
											</div>
											<div class="form-group">
												<a class="lnk-toggler" data-panel=".panel-signup" href="#"
													onclick="changeToSigninForm()">Chưa có tài khoản?</a>
											</div>
										</form>
									</div>
								</div>
	...
	<script src="<c:url value="./assets/javascript/login.js"></c:url>"></script>
</body>