...
<head>
    ...
    <link href="assestSeller/css/order_form.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="row form_modal product js-modal">
            <div class="container-fluid">
                <!-- DataTales Example -->
                <div class="card shadow mb-4 content-modal">
                    <i class="fa-solid fa-xmark btn-exit js-btn-close"></i>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                <thead>
    ...
    <script type="text/javascript" src="./assets/javascript/sellerStatus.js"></script>
</body>
