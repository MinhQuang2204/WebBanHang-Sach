...
<head>
    ...
    <title>NHQBook - Forgot Password</title>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-password-image bg-login-title">NHQBook</div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="layout-registerAdmin">Chưa có tài khoản? Đăng kí.</a>
                                    </div>
                                    <div class="text-center">
